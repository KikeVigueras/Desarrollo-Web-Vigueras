...
namespace UTTT.Ejemplo.Persona
{
    public partial class PersonaPrincipal : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!this.IsPostBack)
                {
                    ...
                    this.idBusqueda.DataTextField = "strValor";
                    this.idBusqueda.DataValueField = "id";
                    this.idBusqueda.DataSource = estadosCiviles;
                    this.idBusqueda.DataBind();
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            {
                this.showMessage("Ocurrio un a la hora de Buscar.");
            }
        }
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            {
                this.showMessage("Ocurrio un a la hora de agregar.");
            }
        }
        ...
        protected void DataSourcePersona_Selecting(object sender, LinqDataSourceSelectEventArgs e)
        {
            try
            {
                ...
                Expression<Func<UTTT.Ejemplo.Linq.Data.Entity.Persona, bool>> 
                    predicate =
                    (c =>
                    ((sex) ? c.idCatSexo == int.Parse(this.ddlSexo.Text) : true) &&
                    ((edocivil) ? c.idEstadoCivil == int.Parse(this.idBusqueda.Text) : true) &&

                    ((name) ? (((name) ? c.strNombre.Contains(this.txtNombre.Text.Trim()) : false)) : true)
                    );
        ...
        protected void dgvPersonas_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                this.showMessage("Ocurrio un a la hora de Seleccionar.");
            }
        }
