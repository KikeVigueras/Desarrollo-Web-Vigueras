...
{
    public partial class AgregarUser : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Response.Redirect("~/UsuarioPrinc.aspx", false);
            }
        ...
        private bool validacion(Usuario _usuario, ref String mensaje)
        {
            ...
            {
                mensaje = "El campo nombre sobre pasa el rango de caracteres";
                return false;
            }
            if (_usuario.strNombreUsuario.Length < 3)
            {
                mensaje = "El rango debe ser mayor a 3 cacateres";
                return false;
            }
            ...
            {
                mensaje = "El rango es mayor a lo admitido";
                return false;
            }
            if (this.txtContrasena.Text.Trim().Length < 5)
            {
                mensaje = "El rango es de 5 caracteres";
                return false;
            }
            ...
            {
                mensaje = "Favor de ingresar la fecha, esta celda es obligatoria";
                return false;
            }
            ...
            {
                mensaje = "El formato gecha debe ser:  dd/MM/yyyy";
                return false;
            }
            ...
            {
                mensaje = "El rango es de 01/01/1753 hasta la fecha actual";
                return false;
            }
            return true;
        }
        ...
        public bool sqlValidaConsultaEditar(Usuario usuario, ref String mensaje)
        {
            ...
            if (userCount > 0)
            {
                mensaje = "El usuario coincide con uno ya inscrito, utiliza otro o comunicate a sistemas";
                return false;
            }
            return true;
        }
