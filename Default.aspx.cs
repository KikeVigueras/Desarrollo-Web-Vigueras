        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (resultado)
                {
                    this.limpiar();
                    this.setGridView();
                    Response.Write("<script type=\"text/javascript\">alert('Guardado Exitosamente');</script>");                    
                }
                else
                {
                    Response.Write("<script type=\"text/javascript\">alert('No se realizo la opcion de guardar');</script>");
                }                
            }
            catch (Exception _e)
            { 
